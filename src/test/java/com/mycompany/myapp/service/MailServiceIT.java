...
class MailServiceIT {
    ...
    void testSendEmail() throws Exception {
        ...
        assertThat(message.getAllRecipients()[0]).hasToString(
            "john.doe@example.com"
        );
    ...
    void testSendMultipartEmail() throws Exception {
        ...
        MimeBodyPart part = (MimeBodyPart) ((MimeMultipart) mp
                .getBodyPart(0)
                .getContent()).getBodyPart(0);
    ...
    void testSendLocalizedEmailForAllSupportedLanguages() throws Exception {
        ...
        for (String langKey : languages) {
            ...
            String propertyFilePath =
                "i18n/messages_" +
                getMessageSourceSuffixForLanguage(langKey) +
                ".properties";
            URL resource =
    ...
    private String getMessageSourceSuffixForLanguage(String langKey) {
        ...
        if (matcher2.matches()) {
            javaLangKey = matcher2.group(1) +
            "_" +
            matcher2.group(2).toUpperCase();
        }
        Matcher matcher3 = PATTERN_LOCALE_3.matcher(langKey);
        if (matcher3.matches()) {
            javaLangKey = matcher3.group(1) +
            "_" +
            matcher3.group(2) +
            "_" +
