    ...
    <div className="PersonalPage">
      {personEntity.cover ? (
        <div className="PersonalPage-cover">
          {personEntity.coverContentType ? <img src={`data:${personEntity.coverContentType};base64,${personEntity.cover}`} /> : null}
        </div>
      ) : null}
        ...
        <div className="PersonalPage12">
          <div className="PersonalPage221">
            ...
            {personEntity.id === currentUser.person?.id && (
              <Button tag={Link} to={`/personalupdatepage/${personEntity.id}`} replace color="">
      ...
      <div className="PersonalPage-tabs">
        <Button color={activeTab === 'about' ? 'primary' : 'secondary'} onClick={() => setActiveTab('about')}>
          About
        </Button>
      ...
      {activeTab === 'about' && (
        <div className="profile-bio">
          ...
          {personEntity.createdAt && (
            <div>
              <FontAwesomeIcon icon={faCalendarAlt} /> <TextFormat value={personEntity.createdAt} type="date" format={APP_DATE_FORMAT} />
            </div>
          )}
        </div>
      )}
