...
import { getEntities } from 'app/entities/person/person.reducer';
import PersonTable from './person-table';

// import { getEntities } from './person.reducer';

export const PersonApprovePage = () => {
      ...
      <h2 id="person-heading" data-cy="PersonHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          >
            ...
            <Translate contentKey="seaportApp.person.home.refreshListLabel">
              Refresh List
            </Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="seaportApp.person.home.createLabel">
              Create new Person
            </Translate>
          </Link>
        </div>
