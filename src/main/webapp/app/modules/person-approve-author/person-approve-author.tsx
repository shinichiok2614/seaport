...
export const PersonApprovePage = () => {
  ...
  const filteredPersons = personList.filter(person => person.name.toLowerCase().includes(searchQuery.toLowerCase()));
  return (
    <div>
      ...
      <PersonTable personList={personList} loading={loading} sort={sort} getSortIconByFieldName={getSortIconByFieldName} />
    </div>
  );
};
