...
export const MessagePersonRoomMemberUpdate = () => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2
            id="seaportApp.roomMember.home.createOrEditLabel"
            data-cy="RoomMemberCreateUpdateHeading"
          >
            <Translate contentKey="seaportApp.roomMember.home.createOrEditLabel">
              Create or edit a RoomMember
            </Translate>
          </h2>
        </Col>
      </Row>
...
export default MessagePersonRoomMemberUpdate;
