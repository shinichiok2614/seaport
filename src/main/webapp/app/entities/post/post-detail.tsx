...
export const PostDetail = () => {
    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {postEntity.approvedAt ? (
              <TextFormat
                value={postEntity.approvedAt}
                type="date"
                format={APP_DATE_FORMAT}
              />
            ) : null}
  ...
  // return <PostView postEntity={postEntity} />;
};
