  ...
  return (
    <div>
      <h2 id="comment-heading" data-cy="CommentHeading">
        <Translate contentKey="seaportApp.comment.home.title">
          Comments
        </Translate>
        <div className="d-flex justify-content-end">
          ...
          >
            ...
            <Translate contentKey="seaportApp.comment.home.refreshListLabel">
              Refresh List
            </Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="seaportApp.comment.home.createLabel">
              Create new Comment
            </Translate>
          </Link>
        </div>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="seaportApp.comment.description">
                    Description
                  </Translate>{' '}
                  <FontAwesomeIcon
                    icon={getSortIconByFieldName('description')}
                  />
                </th>
                <th className="hand" onClick={sort('image')}>
                  <Translate contentKey="seaportApp.comment.image">
                    Image
                  </Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('image')} />
                </th>
                <th className="hand" onClick={sort('createdAt')}>
                  <Translate contentKey="seaportApp.comment.createdAt">
                    Created At
                  </Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdAt')} />
                </th>
                <th className="hand" onClick={sort('updateAt')}>
                  <Translate contentKey="seaportApp.comment.updateAt">
                    Update At
                  </Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('updateAt')} />
                </th>
                <th>
                  <Translate contentKey="seaportApp.comment.post">
                    Post
                  </Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="seaportApp.comment.comment">
                    Comment
                  </Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/comment/${comment.id}/delete`)
                        }
                        color="danger"
                        size="sm"
