...
export const CommentUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...
      comment: users.find(it => it.id.toString() === values.comment?.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          comment: commentEntity?.comment?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="seaportApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
            <Translate contentKey="seaportApp.comment.home.createOrEditLabel">Create or edit a Comment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('seaportApp.comment.createdAt')}
              ...
              />
              <ValidatedField
                label={translate('seaportApp.comment.updateAt')}
                id="comment-updateAt"
                name="updateAt"
                data-cy="updateAt"
                type="datetime-local"
              ...
              />
              <ValidatedField id="comment-post" name="post" data-cy="post" label={translate('seaportApp.comment.post')} type="select">
                <option value="" key="0" />
                {posts
              ...
              <ValidatedField
                ...
                name="comment"
                data-cy="comment"
                label={translate('seaportApp.comment.comment')}
                type="select"
              >
                <option value="" key="0" />
                {users
