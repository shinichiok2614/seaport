...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMMEMBER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOMMEMBER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOMMEMBER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ROOMMEMBER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ROOMMEMBER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROOMMEMBER actions', async () => {
      const arg = 42666;
