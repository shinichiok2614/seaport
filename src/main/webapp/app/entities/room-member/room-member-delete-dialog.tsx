...
import { getEntity, deleteEntity } from './room-member.reducer';
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="seaportApp.roomMember.delete.question">
        <Translate contentKey="seaportApp.roomMember.delete.question" interpolate={{ id: roomMemberEntity.id }}>
