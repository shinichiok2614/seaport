...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './paragraph.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARAGRAPH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARAGRAPH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARAGRAPH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARAGRAPH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARAGRAPH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARAGRAPH actions', async () => {
      const arg = 42666;
