            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('image')}>
                  <Translate contentKey="seaportApp.post.image">
                    Image
                  </Translate>{' '}
                ...
                <th className="hand" onClick={sort('approvedAt')}>
                  ...
                  <FontAwesomeIcon
                    icon={getSortIconByFieldName('approvedAt')}
                  />
                </th>
                <th className="hand" onClick={sort('modifiedAt')}>
                  ...
                  <FontAwesomeIcon
                    icon={getSortIconByFieldName('modifiedAt')}
                  />
                </th>
                <th>
            ...
            <tbody>
              {postList.map((post, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate
                      contentKey={`seaportApp.Status.${post.status}`}
                    />
                  </td>
                  <td>{post.view}</td>
                  <td>{post.remark}</td>
                    ...
                    <div className="btn-group flex-btn-group-container">
                      ...
                      >
                        ...
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.createcontent">
                            Create Content
                          </Translate>
                        </span>
                      </Button>
