...
public class MessageResource {
     ...
     *         body the new messageDTO, or with status {@code 400 (Bad Request)} if
     *         the message has already an ID.
     ...
     *         the updated messageDTO,
     *         or with status {@code 400 (Bad Request)} if the messageDTO is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the messageDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    ...
    /**
     * {@code PATCH  /messages/:id} : Partial updates given fields of an existing
     * message, field will ignore if it is null
     *
     * @param id         the id of the messageDTO to save.
     * @param messageDTO the messageDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the messageDTO is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the messageDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the messageDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<List<MessageDTO>> findAllByMessageId(@PathVariable("id") Long id) {
        List<MessageDTO> messageDTO = messageService.findAllByMessageId(id);
